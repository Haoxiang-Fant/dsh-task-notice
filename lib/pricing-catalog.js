/**
 * 内置官方价格目录(0.3.6):主流 LLM 的官方 API 价格,单位「每 1M tokens」。
 *
...
export const OFFICIAL_PRICE_CATALOG = {
  ...
  'deepseek-v4.1-flash': entry({ cny: {"cacheIn":0.02,"cacheOut":1,"output":4,"cacheWrite":0,"reasoning":0}, match: ["deepseek-flash","deepseek-v4-1-flash"], source: "DeepSeek · 《大模型API定价对比(4).csv》" }),
