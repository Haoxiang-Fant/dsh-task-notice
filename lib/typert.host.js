      ...
      services: [
        {
          ...
          members: [
            ...
            { kind: 'method', name: 'resetPlanCycle', signature: 'resetPlanCycle(key: string, fromMs: number, toMs: number): UsageAnalysis', summary: '手动重置指定 Provider 的 Token Plan 当前计费周期(归档为上一轮)。', jsDoc: '/** 重置 Token Plan 计费周期 */' },
