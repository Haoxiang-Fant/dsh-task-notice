  ...
  factory: (require) => {
    ...
    function StatsSection(props) {
      ...
      return el('div', { className: 'tn-section' },
        // 顶部导航栏(0.3.2 顺序):消耗统计 ⇄ 使用分析 ⇄ 价格编辑 ⇄ 设置
            ...
            el('div', { className: 'tn-pie-wrap' },
              ...
              el('div', { className: 'tn-legend' },
                slices.map((s) => el('div', { className: 'tn-legend-item', key: s.m.model },
                  ...
                  el('span', { className: 'tn-legend-val', title: fmtExact(s.m.cost) }, fmtMoney(s.m.cost, currencySymbol) + ' · ' + ((s.m.cost / totalCost) * 100).toFixed(1) + '%'))),
